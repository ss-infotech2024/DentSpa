            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-end p-4">
                <div className="bg-black/50 w-full text-center py-2 rounded">
                  <h3 className="text-white group-hover:text-[#C8A97E] text-xl font-semibold tracking-wide transition-colors duration-300" style={{ textShadow: '0 0 8px rgba(0, 0, 0, 0.8)' }}>
                    {treatment.title}
                  </h3>
                  <p className="text-gray-200 text-sm mt-1 px-2" style={{ textShadow: '0 0 6px rgba(0, 0, 0, 0.7)' }}>
