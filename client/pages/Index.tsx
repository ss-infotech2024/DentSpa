        ...
        <div className="flex-1 lg:pl-16 max-w-2xl">
          <blockquote className="text-foreground text-base md:text-lg leading-relaxed text-center lg:text-left">
            <p className="mb-4 md:mb-6">
              "Dentistry is not just work for me, it is my passion. I practice
              all aspects of dentistry in my clinics but my work is based around
              the
            </p>
            <p className="mb-4 md:mb-6">
            ...
            <p className="mb-4 md:mb-6">
              means that we recognise the importance of having a beautiful
              natural
            </p>
